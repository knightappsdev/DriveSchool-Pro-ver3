...
import { users, instructors, students, courses, bookings, lessons, reviews } from '@/lib/db/schema';
import { count, eq, avg, sum, and } from 'drizzle-orm';
...
export async function GET() {
  try {
    ...
    const stats = {
      ...
      avgRating: Number(avgRatingResult[0]?.avgRating || 4.5),
    };
