...
export const drivingInstructors: Instructor[] = [
  ...
  },
  {
    ...
    location: 'Bristol',
    experience: 9,
    specialties: ['Eco Driving', 'City Driving', 'Green Initiatives'],
    transmissionTypes: ['manual', 'automatic'],
    pricePerHour: 34,
    availability: 'Available next week',
    bio: 'Environmentally conscious instructor teaching eco-driving techniques. Specializes in city driving and sustainable driving practices.',
