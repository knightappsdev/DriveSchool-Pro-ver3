...
import { Star, MapPin, Clock, Car, Phone, MessageCircle } from 'lucide-react';
...
export default function InstructorCard({ instructor, onViewProfile, onContact }: InstructorCardProps) {
